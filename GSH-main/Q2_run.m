...
lonLim =    [0.5 359.5 1];%[-180 180 1] [deg] min longitude, max longitude, resolution longitude (preferable similar to latitude)
height =    0000.0; % height of computation above spheroid 225000
...
DATE = datestr(now);
save(['Results/data_' Model.name '_' num2str(SHbounds(1)) '_' num2str(SHbounds(2)) '_rightsize_0km'  '.mat'],'data')
