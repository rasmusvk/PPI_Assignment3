...
% % Topography layer
Model.l1.bound = [HOME '/Data/Q3.bd1.gmt'];%if character-->km, 
Model.l1.dens  = 2960;%in g/cm3 if numeric-->kg/m^3
% %Model.l1.alpha = 

% Crust layer
Model.l2.bound = [HOME '/Data/Q3.bd2.gmt'];%Q3
Model.l2.dens  = 2960; %in kg/m^3
% %Model.l2.alpha = 
% 
% % Mantle layer
Model.l3.bound = [HOME '/Data/Q3.bd3.gmt'];
%Model.l3.dens  = 3.450;
