...
load('Results/data_Crust10_crust_3_110_og.mat')
...
%%
sqrt(data.ten.Tzz(1,1).^2+data.ten.Txz(1,1).^2+data.ten.Tyz(1,1).^2+data.ten.Txx(1,1).^2+data.ten.Txy(1,1).^2+data.ten.Tyy(1,1).^2)
