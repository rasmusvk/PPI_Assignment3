...
lonLim =    [0 360 1];%[-180 180 1] [deg] min longitude, max longitude, resolution longitude (preferable similar to latitude)
...
DATE = datestr(now);
save(['Results/data_' Model.name '_' num2str(SHbounds(1)) '_' num2str(SHbounds(2)) '_1_0km'  '.mat'],'data')
